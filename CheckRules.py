...
def check_cards(cards):
    ...
    if len(cards) == 6 and len(set(cards)) == 2:
        return '双三'

    if len(cards) == 4 and len(set(cards)) == 1:
        return '炸弹'

    if len(cards) == 4 and max_char_count(cards) == 3 and len(set(cards)) == 2:
        return '三带一'
    ...
    if len(cards) >= 9 and is_feiji_string(cards) and len(cards) % 3 == 0:
        return '三顺'

    if len(cards) == 8 and max_char_count(cards) == 3 and len(set(cards)) == 4:
        return '飞机'

    if len(cards) == 10 and max_char_count(cards) == 3 and len(set(cards)) == 4:
        return '飞机带翅膀'
